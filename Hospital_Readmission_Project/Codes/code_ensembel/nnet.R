...
model11 = train(subset(model1,select=-c(target)),model1$target,'nnet',trControl=trainControl(method='cv',number=2,verboseIter = T))
model22 = train(subset(model2,select=-c(target)),model2$target,'nnet',trControl=trainControl(method='cv',number=2,verboseIter = T))
model33 = train(subset(model3,select=-c(target)),model3$target,'nnet',trControl=trainControl(method='cv',number=2,verboseIter = T))
model44 = train(subset(model4,select=-c(target)),model4$target,'nnet',trControl=trainControl(method='cv',number=2,verboseIter = T))
model55 = train(subset(model5,select=-c(target)),model5$target,'nnet',trControl=trainControl(method='cv',number=2,verboseIter = T))
model66 = train(subset(model6,select=-c(target)),model6$target,'nnet',trControl=trainControl(method='cv',number=2,verboseIter = T))
model77 = train(subset(model7,select=-c(target)),model7$target,'nnet',trControl=trainControl(method='cv',number=2,verboseIter = T))
...
final_no$Within30days=ifelse(final_no$Within30days>0.476,1,0)
...
write.csv(final_cluster,"final_cluster_nnet.csv")
